...
Нативный тест-раннер `php tests/run.php` (без Composer) выполняет 378 unit-тестов
без БД и 478 тестов в полном CI-прогоне с MariaDB. Покрыты рендеринг блоков,
