...
Нативный тест-раннер `php tests/run.php` (без Composer) выполняет 380 unit-тестов
без БД и 480 тестов в полном CI-прогоне с MariaDB. Покрыты рендеринг блоков,
