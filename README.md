...
См. технический бэклог (Блоки 1–11): SVG-санитайзер, привязка сессий,
нативный QR для TOTP, GD-оптимизация изображений, файловый кэш, SMTP-клиент,
CLI-миграции, soft-deletes, веб-инсталлятор, ACL-роли, аудит и др.
